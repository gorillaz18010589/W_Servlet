...
/*
4.getCharacterEncoding()=>���oClient�ݽs�X����(�^�ǭ�:String)
20.getReader()=>���orequset����Ʀ�y(�A�Ω�fomrbody�����ǨӪ��Ѽ�)(�^�ǭ�:BufferedReader)
...
//@WebServlet("/T4_ServletRequest����ϥ�")
//public class T4_ServletRequest����ϥ� extends HttpServlet {
// 
//	@Override
...
//			
//			
//			BufferedReader bufferedReader = request.getReader(); //���orequest����y,�^�Ǩ�BufferedReader�W
